    ...
    OutlinedCard(
        ...
        Column(
            ...
            PlantImage(
                ...
                modifier = Modifier
                    .fillMaxWidth()
                    .aspectRatio(16f / 9f).blur(.5.dp)
            )
            //text will be one line and ellipsized, also CENTERED, have a dark background since the text is white and it will be on top of the image.
            ...
            Spacer(modifier = Modifier.height(4.dp))
            //Planted on:
            //if it has not been watered (lastWateredDate =null) then it will display "Not watered yet"
